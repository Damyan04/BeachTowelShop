        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DDSN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirmAdress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MOL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CityFirm = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvoiceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UsersessionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Pixels = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SizePicturePath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignFolderPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DesignName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<double>(type: "float", nullable: false),
                    UserSessionId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_UserSessions_UserSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Underline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FontStyle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Overline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserSessionId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    OrderId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CartItemId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TextProperties_CartItems_CartItemId",
                        column: x => x.CartItemId,
                        principalTable: "CartItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TextProperties_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TextProperties_UserSessions_UserSessionId",
                        column: x => x.UserSessionId,
                        principalTable: "UserSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserSessionId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TextProperties_CartItemId",
                table: "TextProperties",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_TextProperties_OrderId",
                table: "TextProperties",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_TextProperties_UserSessionId",
                table: "TextProperties",
                column: "UserSessionId");
        }
